...
class TypeResolver {
    ...
    getType(node) {
        ...
        const nodeTypeName = getNodeTypeName(this.typescript, checker, node, new Set(), new Map());
        if (nodeTypeName.startsWith("Array<") && nodeTypeName.endsWith(">")) {
            return nodeTypeName.slice(6, -1);
        }
        return nodeTypeName;
    }
}
