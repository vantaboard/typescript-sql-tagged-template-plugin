...
const PG_FORMATTER_PATH = (0, path_1.resolve)(__dirname, "../vendor/pgFormatter/pg_format");
const detectPerl = () => {
    const proc = (0, child_process_1.spawnSync)("perl", ["-v"]);
...
const formatSql = ({ sql, formatOptions, pgFormatterConfigFile, }) => {
    ...
    const proc = (0, child_process_1.spawnSync)("perl", [
        PG_FORMATTER_PATH,
...
const splitSqlByParameters = (sql, numberOfParameters) => {
    const analysis = (0, analysis_1.analyze)(sql);
